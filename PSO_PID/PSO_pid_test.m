function out = PSO_pid_test(problem, params)
    tic
    %%Problem Definition
    ...
    Kd_Min = problem.Kd_Min;          %Lower Bound of Decision Variables
    Kd_Max = problem.Kd_Max;          %Upper Bound of Decision Variables
    VarMin = [Kp_Min Ki_Min Kd_Min];
    VarMax = [Kp_Max Ki_Max Kd_Max];
    ...
    GlobalBest.Cost = inf;
        ...
        for  i = 1:nPop
            ...
            kd = unifrnd(Kd_Min,Kd_Max);


           
            particle(i).Position = [kp ki kd];
